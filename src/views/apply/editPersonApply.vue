  ...
  <div class="app-container">
    <div class="filter-container">
      <el-steps :active="activeStep" align-center>
        <el-step title="步骤1" description="单位登记备案"></el-step>
        <el-step title="步骤2" description="商务签注人员备案"></el-step>
        <el-step title="步骤3" description="企业备案资料上传"></el-step>
      </el-steps>
      <el-tabs style="padding: 30px 30px 0 90px;" v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="单位登记备案" name="first">
          <el-form ref="companyForm" :model="companyForm" :rules="companyrules" label-width="120px">
            ...
            <el-form-item label="单位注册地址" prop="companyaddress">
              <el-input v-model="companyForm.companyaddress"></el-input>
            </el-form-item>
             <el-form-item label="单位办公地址" prop="companyofficeaddress">
              <el-input v-model="companyForm.companyofficeaddress"></el-input>
            </el-form-item>
            <el-form-item label="单位电话" prop="companytel">
              <el-input v-model="companyForm.companytel"></el-input>
            </el-form-item>
            <el-form-item label="单位传真" >
              <el-input v-model="companyForm.companyfax"></el-input>
            </el-form-item>
            <el-form-item label="营业执照">
              <el-card class="box-card">
                <div class="text item">
                  请扫描或者拍摄营业执照，加盖单位公章后，拍照上传！
                </div>
                <el-row>
                  <el-upload
                    action="http://120.78.207.37/api/mobile/index.php?act=beian_apply&op=image_upload"  v-model="companyForm.companylicence"
                  ...
                  <el-dialog :visible.sync="dialogVisible">
                    <img width="100%" :src="companyForm.companylicence" alt="">
                  </el-dialog>
                </el-row>
              </el-card>
            </el-form-item>
            <el-form-item label="申请人" prop="applyer">
              <el-input v-model="companyForm.applyer"></el-input>
            </el-form-item>
            <el-form-item label="申请人电话" prop="applyertel">
              <el-input v-model="companyForm.applyertel"></el-input>
            </el-form-item>
            <el-form-item label="提交时间" v-if="applyed>0">
              <el-input disabled v-model="companyForm.addtime"></el-input>
            </el-form-item>
            <el-form-item label="审核时间" v-if="applyed>1">
              <el-input disabled v-model="companyForm.audittime"></el-input>
            </el-form-item>
            <el-form-item label="状态" v-if="applyed>0">
              <el-input disabled v-model="companyForm.stateDesc"></el-input>
            </el-form-item>
            <el-form-item label="审核意见" v-if="applyed>-1">
              <el-input type="textarea" disabled v-model="companyForm.auditText"></el-input>
            </el-form-item>
            <el-form-item label="" v-if="applyed==0">
              <el-button type="primary" @click="onSubmit">提交申请</el-button>
              <el-button>取消</el-button>
            </el-form-item>
            <el-form-item label="" v-if="companyForm.state==0 || companyForm.state==2">
              <el-button type="primary" @click="onUpdate">下一步</el-button>
            </el-form-item>
          </el-form>
        </el-tab-pane>
        <el-tab-pane label="商务签注人员备案" name="second">
...
<el-form  label-width="120px">
          ...
          <el-table-column type="expand">
              ...
              <el-form label-position="left" inline class="demo-table-expand">
                ...
                <el-col :span="24">
                  <el-form-item label="社保缴纳凭证">
                   <img v-for="item in props.row.sspics" :src="item.url" class="image imagelist" :preview="props.row.id" :preview-text="props.row.username+'的社保缴纳凭证'">
                </el-form-item>
                </el-col>
                </el-row>
              </el-form>
            ...
            <el-table-column label="社保保险号码" prop="socialsecurity">
            </el-table-column>
            ...
            <el-row>
            <el-button type="success" @click="dialogFormVisible = true" style="margin-top:10px;">下载“单位申办赴港澳商务签注人员备案名单表”</el-button>

<el-button type="success" @click="dialogFormVisible = true" style="margin-top: 10px;float: right;margin-right: 10px;">+ 添加签注人员</el-button>
            </el-row>
          </el-card>
          </el-form-item>
          ...
          <el-form  label-width="120px">
          <el-form-item label="单位申请商务签注备案登记表" required>
          <el-card class="box-card">
            <div class="text item">
        ...
        <el-tab-pane label="企业备案资料上传" name="third">
          <el-form ref="applyForm" :model="applyForm" :rules="applyformrules" label-width="120px">
            <el-form-item label="单位申请商务签注备案登记表" prop="companybeianimage">
              <el-card class="box-card">
                <div class="text item">
                  请点击下载“单位申请商务签注备案登记表”，加盖单位公章，并由法人签字后，拍照上传！
                </div>
                <el-row>
                  <el-upload multiple action="http://120.78.207.37/api/mobile/index.php?act=beian_apply&op=image_upload" list-type="picture-card" :on-preview="handlePictureCardPreview" :on-remove="handleWord2Remove"
            ...
            <el-form-item label="代办人姓名" prop="agentname">
              <el-input v-model="applyForm.agentname"></el-input>
            </el-form-item>
            <el-form-item label="代办人电话" prop="agenttel">
              <el-input v-model="applyForm.agenttel"></el-input>
            </el-form-item>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="正面">
                      <el-upload class="avatar-uploader" action="http://120.78.207.37/api/mobile/index.php?act=beian_apply&op=image_upload" :show-file-list="false" :on-success="handleAgentSuccess" :before-upload="beforeAvatarUpload">
                  ...
                  <el-col :span="12">
                    <el-form-item label="反面">
                      <el-upload class="avatar-uploader" action="http://120.78.207.37/api/mobile/index.php?act=beian_apply&op=image_upload" :show-file-list="false" :on-success="handleAgentBackSuccess" :before-upload="beforeAvatarUpload">
            ...
            <el-form-item label="">
              <el-button type="primary" @click="onSubmitApply">提交</el-button>
            </el-form-item>
          </el-form>
        </el-tab-pane>
      </el-tabs>
...
<script>
import { getBeianCompany, addBeianCompany, editBeianCompany, getNewBeianPersons, addBeianPerson, editBeianPerson, delBeianPerson, addBeianApply, updateBoat, fetchAllCompanyList } from '@/api/article'
  ...
  methods: {
    ...
    onSubmitApply() {
      ...
      this.$refs['applyForm'].validate((valid) => {
        if (valid) {
          addBeianApply(vm.applyForm).then(response => {
            console.log(response)
            if (response.code == 200) {
              this.$notify({
                title: '成功',
    ...
    getBeianCompany() {
      ...
      getBeianCompany(this.listQuery).then(response => {
        console.log(response)
        this.applyed = response.datas.number
        if (response.datas.number >= 1) {
          console.log(response.datas.info)
          this.companyForm = response.datas.info
          this.personForm.companyid = response.datas.info.id
          this.personForm.companyname = response.datas.info.companyname

          this.applyForm.companyid = response.datas.info.id
          this.applyForm.companyname = response.datas.info.companyname

          if( response.datas.info.state ==2 ){
            this.activeStep = 1;
    ...
    getBeianPesons() {
      this.listLoading = true
      getNewBeianPersons({companyid:this.companyForm.id}).then(response => {
        console.log(response)
        if(response.code==200){
