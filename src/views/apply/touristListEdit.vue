    ...
    <div class="filter-container">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="120px">
        ...
        <el-row>
          <el-col :span="6">
            <el-form-item label="客户编码" prop="touristCode">
              <el-input v-model="ruleForm.touristCode" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="性别" prop="sex">
              <el-select v-model="ruleForm.gender" style="width:100%;">
                <el-option v-for="item in sex" :value="item" :key="item"></el-option>
              </el-select>
              <span></span>
            </el-form-item>
          </el-col>
        ...
        <el-form-item label="护照信息页" prop="passportPhoto">
          <el-upload
            action="http://120.78.207.37/api/mobile/index.php?act=nanji_admin&op=image_upload"
          ...
          >
           ...
           <span style="font-size:12px;color:red;">(提示只需添加护照首页)</span>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="国籍" prop="nationality">
              <el-select filterable v-model="ruleForm.nationality" style="width:100%;">
                <el-option v-for="item in national" :label="item.label" :value="item.value" :key="item.label"></el-option>
              </el-select>
              <span></span>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="居留或双重国籍" prop="dualNationality">
              <el-select filterable v-model="ruleForm.dualNationality" style="width:100%;">
          ...
          <el-col :span="8">
            <el-form-item  label="其他国籍" prop="otherNationality">
              <el-select filterable v-model="ruleForm.otherNationality" style="width:100%;">
                <el-option v-for="(item,index) in national" :label="item.label" :value="item.value" :key="index"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-form-item label="意向区域" prop="wishArea">
            <el-checkbox v-for="(val,key,index) in wishAreaobj" v-model="wishAreaobj[key]" @change="clearSonInfo(key)">{{key}}</el-checkbox>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <el-form-item label="是否去过南极（不通过企鹅环游）" prop="applyertel">
          <el-radio v-model="ruleForm.visited" label="true" @change="clearInfo">是</el-radio>
          <el-radio v-model="ruleForm.visited" label="false">否</el-radio>
        </el-form-item>
        <el-row v-show="ruleForm.visited ==='true'">
          <el-col :span="12">
        ...
        <el-form-item label="路线" v-show="ruleForm.visited ==='true'" prop="line">
        ...
        <el-form-item label="游轮公司和游轮"  prop="line" v-show="ruleForm.visited ==='true'" >
          <el-select v-model="ruleForm.lineCompany" placeholder="请选择" @change="getTripList" filterable>
            <el-option v-for="item in companyList"
             ...
             <el-select v-model="ruleForm.lineShip" placeholder="请选择" filterable>
  ...
  data() {
    var checkPhone = function (rule, value, callback) {
      if(!(/^1[3456789]\d{9}$/.test(value))){ 
        callback(new Error('请输入正确格式手机号(11位数字)'))
    } 
      callback();
...
,
  ...
  methods: {
    ...
    //总区域字段校验  this.ruleForm.wishArea
    checkWishArea() {
      var wishAreaString = "";
      for (
        let index = 0;
    ...
    createData() {
      ...
      this.$refs['ruleForm'].validate(valid => {
        if (valid) {
          addtouristinfo(vm.ruleForm).then(response => {
                console.log(response)
            if (response.code == 200) {
              this.$notify({
                title: "成功",
