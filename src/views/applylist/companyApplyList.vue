          ...
          <el-row>
                ...
                <el-row> 
                  <el-form-item label="" style="width:100%">
                      ...
                      <el-row>                  
                        <img :src="props.row.companylicence" class="image imagelist" :preview="props.row.id" :preview-text="props.row.companyname+'的营业执照'">
                      </el-row>
                    </el-card>    
                  </el-form-item>
                  </el-row>
                  ...
                  <el-row> 
                  <el-form-item label="">
                    <span>注册地址：{{ props.row.companyaddress }}</span>
                  </el-form-item>
                  </el-row>
                  ...
                  <el-row> 
                  <el-form-item label="">
                    <span>经营地址：{{ props.row.companyofficeaddress }}</span>
                  </el-form-item>
                  </el-row> 
                </el-col>
                <el-col :span="16">
                  ...
                  <el-form-item label="" style="width:100%">
                      <el-row> 
                      <div class="text item">
                          {{ props.row.applytime }}：{{ props.row.applyer }} 提交申请；
                      </div>
...
<script>
import { getMyBeianCompanyList, delBeianCompany, fetchPv, createBoat, deleteBoat, updateBoat, fetchAllCompanyList } from '@/api/article'
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      this.$router.push({path: '/apply/editCompanyApply', query: {applyid:row.id} })
    },
    addBeian(row) {
