<template>
  <div class="app-container">
    ...
    <el-form-item label="">
      <el-select  @change='handleFilter' placeholder="船只分组" v-model="listQuery.groupid">
        <el-option v-for="item in  shipGroupOptions" :key="item.id" :label="item.value" :value="item.id">
          </el-option>
      </el-select>
    </el-form-item>
    ...
    <el-form-item label="">
      <el-input  @keyup.enter.native="handleFilter"  placeholder="船长姓名或电话"  v-model="listQuery.captain"></el-input>
    </el-form-item>
    ...
    <el-form-item label="">
      <el-input  @keyup.enter.native="handleFilter"  placeholder="所属单位名称"  v-model="listQuery.company"></el-input>
    </el-form-item>
      ...
      <template slot-scope="props">
        <el-form label-position="left" inline class="demo-table-expand">
          ...
          <el-form-item label="船只ID">
            <span>{{ props.row.ShipId }}</span>
          </el-form-item>
          <el-form-item label="船只分组">
          ...
          <el-form-item label="类型">
            <span>{{ props.row.ShipType }}</span>
          </el-form-item>
          <el-form-item label="船长">
            <span>{{ props.row.ShipCaptain }}</span>
          </el-form-item>

          <el-form-item label="船长电话">
            <span>{{ props.row.ShipTel }}</span>
          </el-form-item>
          <el-form-item label="设备ID">
            <span>{{ props.row.EquipId }}</span>
          </el-form-item>
          <el-form-item label="传感器">
            <span>{{ props.row.SensorType }}</span>
          </el-form-item>

          <el-form-item label="船长">
            <span>{{ props.row.ShipLength }}</span>
          </el-form-item>

          <el-form-item label="船宽">
            <span>{{ props.row.ShipWidth }}</span>
          </el-form-item>

          <el-form-item label="空载">
            <span>{{ props.row.EmptyDraft }}</span>
          </el-form-item>

          <el-form-item label="满载">
            <span>{{ props.row.FullDraft }}</span>
          </el-form-item>

          <el-form-item label="所属单位">
            <span>{{ props.row.ShipCompany }}</span>
          </el-form-item>

          <el-form-item label="单位联系人">
            <span>{{ props.row.ShipCompanyContacter }}</span>
          </el-form-item>

          <el-form-item label="联系人电话">
            <span>{{ props.row.ShipCompanyPhone }}</span>
          </el-form-item>

          <el-form-item label="新增时间">
          <span class="link-type">{{props.row.AddTime | parseTime('{y}-{m}-{d} {h}:{i}')}}</span>
...
<script>
import { fetchBoatList, fetchGroupList, fetchPv, createBoat, deleteBoat, updateBoat, fetchAllCompanyList } from '@/api/article'
...
export default {
  ...
  methods: {
    getList() {
      ...
      fetchBoatList(this.listQuery).then(response => {
        console.log(response)
        this.list = response.datas.ship_list || []
    ...
    if(!this.hasPermission('updateShip')){
        this.$notify({
              title: '没有权限',
              message: '当前用户没有操作权限',
              type: 'success',
